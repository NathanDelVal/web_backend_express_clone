...
var gammautils = require('../../../core/gammautils'),
    ...
    ie = require('../../../core/inscricaoestadual'),
...
var Danfe = (function() {
    ...
    Danfe.prototype.comTipo = function(_tipo) {
        if(['entrada', 'saída'].indexOf(_tipo) === -1) {
            throw new Error('Os valores permitidos são as strings "entrada" e "saída"');
        }
        this._tipo = _tipo;
        return this;
    };
    ...
    //verificar esse cara aqui (dia 30)
