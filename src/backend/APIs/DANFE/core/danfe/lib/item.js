...
var gammautils = require('../../../core/gammautils'),
    insert = gammautils.string.insert,
    brasil = require('../../../core/brasil/brazilian'),
...
var Item = (function () {
    ...
    Item.prototype.comNcmSh = function (_ncmSh) {
        ...
        /* Validação por lista de NCMs removida 31/03/2021
    ...
    Item.prototype.comCfop = function (_cfop) {
        ...
        /* Validação por lista de CFOPs removida 31/03/2021
    ...
    Item.prototype.comAliquotaDoIcms = function (_aliquotaDoIcms) {
        ...
        _aliquotaDoIcms = (_aliquotaDoIcms /100)
        if (_aliquotaDoIcms < 0 || _aliquotaDoIcms >= 1) {
    ...
    Item.prototype.comAliquotaDoIpi = function (_aliquotaDoIpi) {
        _aliquotaDoIpi = (_aliquotaDoIpi /100)
        if (_aliquotaDoIpi < 0 || _aliquotaDoIpi >= 1) {
            throw new Error('Aliquota do IPI deve estar entre 0 e 1');
        }
