...
function telefone(texto) {
    ...
    //verifica se primeiro digito é = 0 e remove
...
module.exports.inscricao_estadual = inscricao_estadual;
function inscricao_estadual(texto) {

    texto = texto.trim().replace(/-/g, "").replace(/\./g, "");

    return texto.substr(0, 2) + "." + texto.substr(2, 3) + "." + texto.substr(5, 3) + "-" + texto.substr(8, 9);
