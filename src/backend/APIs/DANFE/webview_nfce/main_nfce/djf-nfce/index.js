const xmlModel = require('../djf-xml-nfce')
...
function NfeModel (content) {
  ...
  return {
    ...
    //Novos NFCE - Victor Eustáquio
    qrCode: function(){
      var qrCode = xml.tagValue(['qrCode'])
      if (qrCode) {
        return (qrCode)
      }
      return ''
    ...
    formaPagamento: function () {
      var vFormaPagamento = xml.tagValue(['tPag'])
      if (vFormaPagamento) {
        if (vFormaPagamento === '01') {
          return ('Dinheiro')
        }
        if (vFormaPagamento === '02') {
          return ('Cheque')
        }
        if (vFormaPagamento === '03') {
          return ('Cartão de Crédito')
        }
        if (vFormaPagamento === '04') {
          return ('Cartão de Débito')
        }
        if (vFormaPagamento === '05') {
          return ('Crédito Loja')
        }
        if (vFormaPagamento === '10') {
          return ('Vale Alimentação')
        }
        if (vFormaPagamento === '11') {
          return ('Vale Refeição')
        }
        if (vFormaPagamento === '12') {
          return ('Vale Presente')
        }
        if (vFormaPagamento === '13') {
          return ('Vale Combustível')
        }
        if (vFormaPagamento === '14') {
          return ('Duplicata')
        }
        if (vFormaPagamento === '15') {
          return ('Cédula de Prova')
        }
        if (vFormaPagamento === '90') {
          return ('Sem pagamento')
        }
        if (vFormaPagamento === '99') {
          return ('Outros')
        }        
      }
      return ''
    ...
    detPag: function(){
      var detPag = xml.tagValue(['detPag'])
      if (detPag) {
        return (detPag)
      }
      return ''
    ...
    vTroco: function(){
      var vTroco = xml.tagValue(['vTroco'])
      if (vTroco) {
        return (vTroco)
      }
      return ''
